...
def main(argv):
    ...
    if is_ftrl:
        # DP-FTRL/DP-FTRLM:
        # Use Opacus ONLY for per-sample gradient clipping (noise_multiplier=0) with the provided loader.
        # DP noise is generated by tree aggregation (CummuNoise*) and passed to the FTRL optimizer.
